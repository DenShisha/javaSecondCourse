 ...
 * Интерфейс в Java не может быть подклассом у другого класса, но он может реализовать другой интерфейс * Ключевое слово implements используется классами для реализации интерфейса
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        javaDev.setName("Javaa");
        javaDev.setAge(30);
        javaDev.doWork();
        javaDev.keepSalary();
        System.out.println(javaDev.getFullName());
    }
}
